...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FWarriorGameLevelSet;
class UScriptStruct* FWarriorGameLevelSet::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FWarriorGameLevelSet.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FWarriorGameLevelSet.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWarriorGameLevelSet, (UObject*)Z_Construct_UPackage__Script_Warrior(), TEXT("WarriorGameLevelSet"));
	}
	return Z_Registration_Info_UScriptStruct_FWarriorGameLevelSet.OuterSingleton;
}
struct Z_Construct_UScriptStruct_FWarriorGameLevelSet_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		...
		{ "Comment", "/**\n * \n */" },
#endif
		{ "ModuleRelativePath", "Public/GameInstances/WarriorGameInstance.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_LevelTag_MetaData[] = {
		{ "Category", "GameData.Level" },
		{ "ModuleRelativePath", "Public/GameInstances/WarriorGameInstance.h" },
	};
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWarriorGameLevelSet_Statics::NewProp_LevelTag = { "LevelTag", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWarriorGameLevelSet, LevelTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LevelTag_MetaData), NewProp_LevelTag_MetaData) }; // 133831994
...
{
	if (!Z_Registration_Info_UScriptStruct_FWarriorGameLevelSet.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FWarriorGameLevelSet.InnerSingleton, Z_Construct_UScriptStruct_FWarriorGameLevelSet_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FWarriorGameLevelSet.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UWarriorGameInstance;
UClass* UWarriorGameInstance::GetPrivateStaticClass()
{
	using TClass = UWarriorGameInstance;
	if (!Z_Registration_Info_UClass_UWarriorGameInstance.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("WarriorGameInstance"),
			Z_Registration_Info_UClass_UWarriorGameInstance.InnerSingleton,
			StaticRegisterNativesUWarriorGameInstance,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UWarriorGameInstance.InnerSingleton;
}
UClass* Z_Construct_UClass_UWarriorGameInstance_NoRegister()
{
	return UWarriorGameInstance::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UWarriorGameInstance_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		{ "IncludePath", "GameInstances/WarriorGameInstance.h" },
		{ "ModuleRelativePath", "Public/GameInstances/WarriorGameInstance.h" },
	};
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UWarriorGameInstance_GetGameLevelByTag, "GetGameLevelByTag" }, // 3130006355
	};
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWarriorGameInstance_Statics::NewProp_GameLevelSets_Inner = { "GameLevelSets", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FWarriorGameLevelSet, METADATA_PARAMS(0, nullptr) }; // 3458860991
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UWarriorGameInstance_Statics::NewProp_GameLevelSets = { "GameLevelSets", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWarriorGameInstance, GameLevelSets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GameLevelSets_MetaData), NewProp_GameLevelSets_MetaData) }; // 3458860991
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UEprojects_Warrior_Source_Warrior_Public_GameInstances_WarriorGameInstance_h__Script_Warrior_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWarriorGameLevelSet::StaticStruct, Z_Construct_UScriptStruct_FWarriorGameLevelSet_Statics::NewStructOps, TEXT("WarriorGameLevelSet"), &Z_Registration_Info_UScriptStruct_FWarriorGameLevelSet, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWarriorGameLevelSet), 3458860991U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UWarriorGameInstance, UWarriorGameInstance::StaticClass, TEXT("UWarriorGameInstance"), &Z_Registration_Info_UClass_UWarriorGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWarriorGameInstance), 3536642362U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UEprojects_Warrior_Source_Warrior_Public_GameInstances_WarriorGameInstance_h__Script_Warrior_4290950494(TEXT("/Script/Warrior"),
	Z_CompiledInDeferFile_FID_UEprojects_Warrior_Source_Warrior_Public_GameInstances_WarriorGameInstance_h__Script_Warrior_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEprojects_Warrior_Source_Warrior_Public_GameInstances_WarriorGameInstance_h__Script_Warrior_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_UEprojects_Warrior_Source_Warrior_Public_GameInstances_WarriorGameInstance_h__Script_Warrior_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEprojects_Warrior_Source_Warrior_Public_GameInstances_WarriorGameInstance_h__Script_Warrior_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
