...
void AWarriorHeroCharacter::PossessedBy(AController* NewController)
{
	...
	{
		const FString ASCText = FString::Printf(TEXT("Owner Actor: %s, AvatarActor: %s"), *WarriorAbilitySystemComponent->GetOwnerActor()->GetActorLabel(), *WarriorAbilitySystemComponent->GetOwnerActor()->GetActorLabel());
