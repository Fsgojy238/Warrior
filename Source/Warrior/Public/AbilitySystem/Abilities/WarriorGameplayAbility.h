...
protected:
	...
	FActiveGameplayEffectHandle BP_ApplyEffectSpecHandleToTarget(AActor* TargetActor, const FGameplayEffectSpecHandle& InSpecHanle, EWarriorSuccessType& OutSuccessType);
};
